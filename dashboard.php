  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        ?>
          <li class="nav-item">
            <a class="nav-link active" href="dashboard.php?pages=datapeminjaman">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex aligns-utems-center">
            <span class="text-light btn btn-outline-light">Selamat Datang,<?= $_SESSION['username']; ?></span>
            <a href="routes/proses.php?aksi=logout" class="text-light btn btn-outline-light ms-2">Logout</a>
          </div>
            ...
            <div class="card-header pb-0 pt-3 bg-transparent">
              <p class="text-sm mb-0">
                ...
                if ($pages == 'users') {
                  @$act = $_GET['act'];
                  if ($act == 'tambah') {
                    include "views/petugas/user/tambah.php";
                  } elseif ($act == 'ubah') {
                    include "views/petugas/user/ubah.php";
                  } else {
                    include "views/petugas/user/users.php";
                  }
                } elseif ($pages == 'buku') {
                  @$act = $_GET['act'];
                  if ($act == 'tambah') {
                  ...
                  include "views/siswa/datapeminjaman.php";
                } else {
                  echo "<h4>SELAMAT DATANG DI PERPUSTAKAAN V2</h4>";
                }
        ...
        <footer class="footer pt-3  ">
          <div class="container-fluid">
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mt-2">
                <div class="copyright text-center text-sm text-muted text-lg-start">
                  © <script>
                    document.write(new Date().getFullYear())
                  </script>,
                  made with <i class="fa fa-heart"></i> by
                  <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Fikri Ufayrah</a>
                  for a better web.
                </div>
              </div>
            </div>
